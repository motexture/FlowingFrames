...
class Upsample(nn.Module):
    def __init__(self, 
        ...
        if use_conv_transpose:
            ...
            conv = InflatedConv(self.channels, self.out_channels, 3, padding=1)
...
class Downsample(nn.Module):
    def __init__(self, 
        ...
        if use_conv:
            conv = InflatedConv(self.channels, self.out_channels, 3, stride=stride, padding=padding)
        else:
            raise NotImplementedError
...
class ResnetBlock(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.conv1 = InflatedConv(in_channels, out_channels, kernel_size=3, stride=1, padding=1)
        ...
        self.conv2 = InflatedConv(out_channels, out_channels, kernel_size=3, stride=1, padding=1)
        ...
        if self.use_in_shortcut:
            self.conv_shortcut = InflatedConv(in_channels, out_channels, kernel_size=1, stride=1, padding=0)
